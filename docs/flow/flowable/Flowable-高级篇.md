...
![image-20220330235847392](\img\image-20220330235847392.png)
...
![image-20220331000011215](\img\image-20220331000011215.png)
...
![image-20220330202443905](\img\image-20220330202443905.png)
...
![image-20220330203056055](\img\image-20220330203056055.png)
...
![image-20220330203233862](\img\image-20220330203233862.png)
...
![image-20220331100340069](\img\image-20220331100340069.png)
...
![image-20220330210538338](\img\image-20220330210538338.png)

控制台输出的结果和我们预期的是一样的

![image-20220330210708334](\img\image-20220330210708334.png)
...
![image-20220331102808059](\img\image-20220331102808059.png)
...
![image-20220330213147240](\img\image-20220330213147240.png)
...
![image-20220330215127129](\img\image-20220330215127129.png)
...
![image-20220330220208085](\img\image-20220330220208085.png)
...
![image-20220330232643286](\img\image-20220330232643286.png)

然后我们执行`user1`的子任务，因为现在流程变量`flag=0`所以会触发终止结束事件

![image-20220330232801450](\img\image-20220330232801450.png)
...
![image-20220330232959807](\img\image-20220330232959807.png)

而且进入到历史数据中也可以看到

![image-20220330233448096](\img\image-20220330233448096.png)
...
![image-20220401110131810](\img\image-20220401110131810.png)



结束取消事件我们只能在事务子流程中使用，在FlowableUI中暂时没有找到这个组件，所以在Eclipse中来绘制

![image-20220401110621048](\img\image-20220401110621048.png)
...
![image-20220401111036816](\img\image-20220401111036816.png)
...
![image-20220401111201815](\img\image-20220401111201815.png)



触发取消结束事件后同时会被取消边界事件捕获而走 取消事件结束的自动任务

![image-20220401111316353](\img\image-20220401111316353.png)



同时自动补偿任务也会触发，关联的自动任务也会触发

![image-20220401111351513](\img\image-20220401111351513.png)

注意在设置的时候需要设置补偿自动任务为可补偿的

![image-20220401111438577](\img\image-20220401111438577.png)
...
![image-20220401111758140](\img\image-20220401111758140.png)
...
![image-20220401202116847](\img\image-20220401202116847.png)
...
![image-20220401202447583](\img\image-20220401202447583.png)
